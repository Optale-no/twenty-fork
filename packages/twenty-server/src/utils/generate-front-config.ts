  ...
  const configObject = {
    window: {
      _env_: {
        ...
        REACT_APP_ORM_GRAPH_URL: process.env.REACT_APP_ORM_GRAPH_URL,
        REACT_APP_OAG_API_BASE_URL: process.env.REACT_APP_OAG_API_BASE_URL,
      },
    },
  };

  const configString = `<!-- BEGIN: Optale CRM Config -->
